...
public class TheEarliestMomentWhenEveryoneBecomeFriends1101 {
    ...
    public TheEarliestMomentWhenEveryoneBecomeFriends1101() {

    }

    public TheEarliestMomentWhenEveryoneBecomeFriends1101(int size){
        root = new int[size];
        rank = new int[size];
...
//        return false;
    ...
    public static void main(String[] args) throws Exception {
        ...
        TheEarliestMomentWhenEveryoneBecomeFriends1101 uf = new TheEarliestMomentWhenEveryoneBecomeFriends1101(n);
